...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference("Pessoa.count") do
      post pessoas_url, params: { pessoa: { email: @pessoa.email, endereco: @pessoa.endereco, id_seq: @pessoa.id_seq, nome: @pessoa.nome, preco: @pessoa.preco } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { email: @pessoa.email, endereco: @pessoa.endereco, id_seq: @pessoa.id_seq, nome: @pessoa.nome, preco: @pessoa.preco } }
